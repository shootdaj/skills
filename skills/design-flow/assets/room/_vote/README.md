...
| `server.py` | Local vote server on 127.0.0.1:7332 (or the port in `room.js` `api`): votes, notes, a small key-value store for pins and duels, and the request queue. Without it the room still works and saves in the browser. |
