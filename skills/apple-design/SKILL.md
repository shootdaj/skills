...
> Adapted from [emilkowalski/skills](https://github.com/emilkowalski/skills/tree/main/skills/apple-design) by Emil Kowalski. Distributed under the MIT License; see `LICENSE.txt`.
